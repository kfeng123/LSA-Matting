...
class decoder_module(nn.Module):
    ...
    def __init__(self, leftp, inp, oup):
        ...
        self.skip_add = nn.Sequential(
                OrderedDict([
                    ("conv", nn.Conv2d(leftp, oup, 3, 1, 1, bias = False)),
    ...
    def forward(self, left, lower):
        return self.decoder(lower) + self.skip_add(left)
...
class theModel(nn.Module):
    ...
    def __init__(self, myArch = "V-19-eSE"):
        ...
        self.decoder_5 = nn.Sequential(
                OrderedDict([
                    ("prelu1", nn.PReLU(self.backbone._out_feature_channels['stage5'])),
        ...
        self.decoder_1 = decoder_module(self.backbone._out_feature_channels['stage1'], decoder_channels_1, 64)

        self.final_upsample = nn.Sequential(
                OrderedDict([
                        ("decov", nn.ConvTranspose2d(64, 32, kernel_size = 4, stride = 2, padding = 1, bias = False)),
        ...
        self.decoder_0 = nn.Sequential(
                OrderedDict([
                    ...
                    ("conv1", nn.Conv2d(decoder_channels_0, 1, 3, 1, 1, bias = False)),
                ])
                )
    ...
    def forward(self, x):
        ...
        x0_decoder = self.final_upsample(x1_decoder)
