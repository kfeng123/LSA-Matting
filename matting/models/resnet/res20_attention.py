...
class theModel(nn.Module):
    ...
    def __init__(self, backbone):
        ...
        #self.attention = my_attention(decoder_channels_0, decoder_channels_4)
        self.local_attention_1 = my_local_attention(decoder_channels_0)
        self.local_attention_2 = my_local_attention(decoder_channels_1)
        self.local_attention_3 = my_local_attention(decoder_channels_2)
        self.local_attention_4 = my_local_attention(decoder_channels_3)

        self.decoder_5 = nn.Sequential(
                nn.PReLU(512),
                nn.Conv2d(512, decoder_channels_4, 3, 1, 1, bias = False),
                nn.BatchNorm2d(decoder_channels_4),
                nn.PReLU(decoder_channels_4),
