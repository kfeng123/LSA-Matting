...
from .decoder.decoder_3 import  decoderModule
...
class theModel(nn.Module):
    def __init__(self):
        ...
        self.backbone = resnet50(inChannel = image_channel)
        self.skip = skipModule_simple(self.backbone._out_feature_channels, lastStage = 3, image_channel = image_channel, ifPPM = True)
        self.decoder = decoderModule(self.skip.outChannels, lastStage = 3, image_channel = image_channel, aux_loss = config.aux_loss, aux_loss_Urysohn = config.aux_loss_Urysohn )
